...
def run_test_better_draw_circles():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles: n = 3  See graphics window')
    print('--------------------------------------------------')
    better_draw_circles(3)

    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles: n = 5  See graphics window')
    print('--------------------------------------------------')
    better_draw_circles(5)

    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles: n = 10  See graphics window')
    print('--------------------------------------------------')
...
def run_test_even_better_draw_circles():
    ...
    print('Testing  better_draw_circles: n = 3  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(1, 200, 'green', 1, 2000)

    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles: n = 5  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(5, 40, 'red', 2, 10)

    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles: n = 10  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(50, 5, 'blue', 20, 2)


def even_better_draw_circles(n, number_of_circles, color, outline_thickness, speed):

    window = rg.RoseWindow(400, 400)

    center = rg.Point(200, 200)
    for k in range(number_of_circles):
        circle = rg.Circle(center, n * (k + 1))
